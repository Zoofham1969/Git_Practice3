...
public class WarmUpTasks_util {

    public static void main(String[] args) {

        maxNum(123, 123);// task 1

         int arr[]={5,2,3,4,5,6,4,7,0,-5,-54,-55,-5,54,-45,-45,-45 };// task 2
        printDesc(arr);//task2

        int[] a1 = {1,2,3,4,5};                 // task 3
        int[] a2 = {6,7,8,9,10,11,12,13,14};//   task 3
        combine2Arrays(a1, a2);             // task 3
